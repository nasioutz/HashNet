...
def produce_config(args):
    ...
    config["snapshot_path"] = join("snapshot", config["dataset"] + "_" + str(args.hash_bit) + "bit_" + args.snapshot[0],
                                   args.snapshot[1] + "_model.pth.tar")
    config["output_path"] = join("snapshot", config["dataset"] + "_" + str(args.hash_bit) + "bit_" + args.prefix)
...
if __name__ == "__main__":
    ...
    args = Arguments(portion_oo_10=10, snapshot=('2018_12_5_21_28_55', 'iter_09000'), hash_bit=48, batch_size=64)
